...
// 			ADC模块配置
//**************************************
#define AHS_NN_FRAME_POINTS 128 //不可改变

//ADC中断点数
#if (defined(TCFG_HOWLING_AHS_NODE_ENABLE) && TCFG_HOWLING_AHS_NODE_ENABLE)
#define AUDIO_ADC_IRQ_POINTS AHS_NN_FRAME_POINTS
#elif defined(TCFG_VIRTUAL_SURROUND_EFF_MODULE_NODE_ENABLE) && TCFG_VIRTUAL_SURROUND_EFF_MODULE_NODE_ENABLE
#define AUDIO_ADC_IRQ_POINTS 354
#else
#define AUDIO_ADC_IRQ_POINTS 128
#endif
#define AUDIO_ADC_IRQ_POINTS_MUSIC_MODE 256
#define AUDIO_ADC_IRQ_POINTS_LOUDSPEAKER_MODE AHS_NN_FRAME_POINTS
...
//IIS中断点数
#if (defined(TCFG_HOWLING_AHS_NODE_ENABLE) && TCFG_HOWLING_AHS_NODE_ENABLE)
#define AUDIO_IIS_IRQ_POINTS AHS_NN_FRAME_POINTS
#elif defined(TCFG_VIRTUAL_SURROUND_EFF_MODULE_NODE_ENABLE) && TCFG_VIRTUAL_SURROUND_EFF_MODULE_NODE_ENABLE
#define AUDIO_IIS_IRQ_POINTS 354
#elif defined(TCFG_AS_WIRELESS_MIC_DSP_ENABLE) && TCFG_AS_WIRELESS_MIC_DSP_ENABLE && TCFG_LLNS_DNS_NODE_ENABLE
#define AUDIO_IIS_IRQ_POINTS 240
#else
#define AUDIO_IIS_IRQ_POINTS 128
#endif
#define AUDIO_IIS_IRQ_POINTS_LOUDSPEAKER_MODE AHS_NN_FRAME_POINTS
...
#if (TCFG_AUDIO_GLOBAL_SAMPLE_RATE % 16000)
#if (defined(TCFG_HOWLING_AHS_NODE_ENABLE) && TCFG_HOWLING_AHS_NODE_ENABLE)
...
/*数字音量最大值定义*/
//27最大数字音量为8192，是16384的一半,即-6dB
#define DEFAULT_DIGITAL_VOLUME   (-6.0f)
...
#define VOL_HW_RL_RR_EN           	1  //调节后左后右的硬件音量
