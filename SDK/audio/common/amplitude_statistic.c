...
#pragma bss_seg(".amplitude_statistic.data.bss")
#pragma data_seg(".amplitude_statistic.data")
#pragma const_seg(".amplitude_statistic.text.const")
#pragma code_seg(".amplitude_statistic.text")
#endif
/*
 ****************************************************************
