...
#define HALF_INEAR_PZ_DELAY         1160
#define HALF_INEAR_TONE_DELAY       1600
...
#elif ICSD_ANC_MODE == TWS_HALF_INEAR_MODE
#define ANC_USER_TRAIN_TONE_MODE    1
#define BYPASS_MAXTIME              1
#define PZ_MAXTIME                  1
...
extern float *ear_canal_mem_data;
extern int *ear_canal_mem_cur_num;
