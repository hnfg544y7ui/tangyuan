...
#pragma bss_seg(".audio_noise_gate.data.bss")
#pragma data_seg(".audio_noise_gate.data")
#pragma const_seg(".audio_noise_gate.text.const")
#pragma code_seg(".audio_noise_gate.text")
#endif
/*
 ******************************************************************
