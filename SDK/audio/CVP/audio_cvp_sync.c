...
#pragma bss_seg(".audio_cvp_sync.data.bss")
#pragma data_seg(".audio_cvp_sync.data")
#pragma const_seg(".audio_cvp_sync.text.const")
#pragma code_seg(".audio_cvp_sync.text")
#endif
...
{
    int wlen;
    int btlen = lmp_private_get_esco_tx_packet_num() * 60;
