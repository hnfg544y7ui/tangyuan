...
#pragma bss_seg(".fs_test.data.bss")
#pragma data_seg(".fs_test.data")
#pragma const_seg(".fs_test.text.const")
#pragma code_seg(".fs_test.text")
#endif
...
#define FILE_NAME SD_ROOT_PATH"abc.txt"
    ...
    void *mnt = (void *)mount(SD_DEV, SD_MOUNT_PATH, "fat", 3, NULL);
    if (mnt) {
...
#if 0
#define SDFILE_NEW_FILE1 	FLASH_RES_PATH"tone/bt.wtg"
#define SDFILE_NEW_FILE2 	FLASH_RES_PATH"cfg_tool.bin"
#define SDFILE_NEW_FILE3 	FLASH_RES_PATH"btif"
#define SDFILE_NEW_FILE4 	FLASH_RES_PATH"cfg_tool.bin"
