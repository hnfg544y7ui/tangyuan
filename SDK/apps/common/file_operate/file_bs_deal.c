...
#pragma bss_seg(".file_bs_deal.data.bss")
#pragma data_seg(".file_bs_deal.data")
#pragma const_seg(".file_bs_deal.text.const")
#pragma code_seg(".file_bs_deal.text")
#endif
/*
 *********************************************************************************************************
 *                                                AC51
