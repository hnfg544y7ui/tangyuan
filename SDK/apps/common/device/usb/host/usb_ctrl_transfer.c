...
int usb_audio_volume_control(struct usb_host_device *host_dev, u8 itf_num, u8 feature_id, u8 channel_num, u16 volume)
{
    ...
    return usb_control_msg(host_dev,
                           ...
                           USB_TYPE_CLASS | USB_RECIP_INTERFACE,
                           (0x02 << 8) | channel_num,
                           (feature_id << 8) | itf_num,
                           &volume,
                           2);
}
int usb_audio_mute_control(struct usb_host_device *host_dev, u8 itf_num, u8 feature_id, u8 mute)
{
