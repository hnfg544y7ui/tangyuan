...
#pragma bss_seg(".led7_ui_api.data.bss")
#pragma data_seg(".led7_ui_api.data")
#pragma const_seg(".led7_ui_api.text.const")
#pragma code_seg(".led7_ui_api.text")
#endif
...
static const struct ui_dis_api *const ui_dis_main[] = {
#if TCFG_APP_BT_EN
    &bt_main,
#endif
...
//  4)子菜单被打断或者时间到了
//=================================================================================//
void ui_set_tmp_menu(u8 app_menu, u16 ret_time, s32 arg, void (*timeout_cb)(int menu))
{
...
//=================================================================================//
static void __ui_user_action(int menu, u16 ret_time, u32 arg, void (*timeout_cb)(int menu))
{
    int ret = false;
...
static void ui_task(void *p)
{
    ...
    while (1) {
        ...
        case UI_MSG_REFLASH:
            ...
            break;
        case UI_MSG_OTHER:
            __ui_user_action(msg[1], msg[3], msg[2], (void (*)(int))msg[4]);
            break;
        case UI_MSG_MENU_SW:
