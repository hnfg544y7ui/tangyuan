...
#pragma bss_seg(".lcd_spi_sh8601a_454x454.data.bss")
#pragma data_seg(".lcd_spi_sh8601a_454x454.data")
#pragma const_seg(".lcd_spi_sh8601a_454x454.text.const")
#pragma code_seg(".lcd_spi_sh8601a_454x454.text")
#endif
/*
...
extern void lcd_drv_cmd_list(u8 *cmd_list, int cmd_cnt);
extern int  lcd_drv_init(void *p);
extern void lcd_en_ctrl(u8 val);


/*
** 初始化代码
*/
static const u8 lcd_sh8601a_cmd_list[] ALIGNED(4) = {
...
void lcd_send_cmd_enable()
{
    ...
    para[0] = 0x5a;
    para[1] = 0x5a;
    imd_write_cmd(0xc0, para, 2);
    imd_write_cmd(0xc1, para, 2);
}
...
static void lcd_adjust_display_brightness(u8 percent)
{
    ...
    /* imd_write_cmd(0x51, para, 2); */
    /* imd_write_cmd(0x4a, para, 2); //Brightness Value of AOD Mode, 无效果 */
    /* imd_write_cmd(0x63, para, 2); //Brightness Value of HBM Mode, 无效果 */
}
...
static void lcd_spi_sh8601a_entersleep(void)
{
    ...
    /* #if DEEP_STANDBY */
    /*     imd_write_cmd(0x4f, &dstb, sizeof(dstb)); */
...
REGISTER_LCD_DEVICE() = {
    ...
    .lcd_cmd = (void *) &lcd_sh8601a_cmd_list,
    .cmd_cnt = sizeof(lcd_sh8601a_cmd_list) / sizeof(lcd_sh8601a_cmd_list[0]),
