...
#define TCFG_EXCEPTION_RESET_ENABLE 0x1 // 异常自动复位
...
#define TCFG_USB_HOST_ENABLE 0x1 // USB主机总开关
#define USB_H_MALLOC_ENABLE 0x1 // 主机使用malloc
#define TCFG_USB_HOST_MOUNT_RESET 0x28 // usb reset时间
#define TCFG_USB_HOST_MOUNT_TIMEOUT 0x32 // 握手超时时间
#define TCFG_USB_HOST_MOUNT_RETRY 0x3 // 枚举失败重试次数
#define TCFG_UDISK_ENABLE 0x1 // U盘使能
#define USB_MALLOC_ENABLE 0x1 // 从机使用malloc
#define TCFG_USB_SLAVE_MSD_ENABLE 0x1 // 读卡器使能
#define TCFG_USB_SLAVE_HID_ENABLE 0x1 // HID使能
#define MSD_BLOCK_NUM 0x1 // MSD缓存块数
#define USB_AUDIO_VERSION USB_AUDIO_VERSION_1_0 // UAC协议版本
#define TCFG_USB_SLAVE_AUDIO_SPK_ENABLE 0x1 // USB扬声器使能
#define SPK_AUDIO_RATE_NUM 0x1 // SPK采样率列表
#define SPK_AUDIO_RES 0x10 // SPK位宽1
#define SPK_AUDIO_RES_2 0x0 // SPK位宽2
#define TCFG_USB_SLAVE_AUDIO_MIC_ENABLE 0x1 // USB麦克风使能
#define MIC_AUDIO_RATE_NUM 0x1 // MIC采样率列表
#define MIC_AUDIO_RES 0x10 // MIC位宽1
#define MIC_AUDIO_RES_2 0x0 // MIC位宽2
...
#define TCFG_FM_INSIDE_AGC_ENABLE 0x1 // 内置FM_AGC使能
#define TCFG_FM_INSIDE_AGC_LEVEL 0xe // 内置FM_AGC初值
#define TCFG_FM_INSIDE_STEREO_ENABLE 0x0 // 内置FM立体声使能
#endif // TCFG_FM_INSIDE_ENABLE

#define TCFG_FM_OUTSIDE_ENABLE 0 // 外置FM配置
#if TCFG_FM_OUTSIDE_ENABLE
#define TCFG_FM_RDA5807_ENABLE 0x0 // FM_RDA5807
#define TCFG_FM_BK1080_ENABLE 0x0 // FM_BK1080
#define TCFG_FM_QN8035_ENABLE 0x0 // FM_QN8035
...
// ------------功能配置.json------------
#define TCFG_APP_BT_EN 0x1 // 蓝牙模式
#define TCFG_APP_MUSIC_EN 0x1 // 音乐模式
#define TCFG_APP_LINEIN_EN 0x1 // LINEIN模式
#define TCFG_APP_FM_EN 0x1 // FM模式
#define TCFG_APP_SPDIF_EN 0x1 // SPDIF模式
#define TCFG_APP_PC_EN 0x1 // PC模式
#define TCFG_APP_RECORD_EN 0x0 // 录音模式
#define TCFG_MIC_EFFECT_ENABLE 0x1 // 混响使能
#define TCFG_DEC_ID3_V2_ENABLE 0x0 // ID3_V2
#define TCFG_DEC_ID3_V1_ENABLE 0x0 // ID3_V1
#define FILE_DEC_REPEAT_EN 0x0 // 无缝循环播放
#define FILE_DEC_DEST_PLAY 0x0 // 指定时间播放
#define FILE_DEC_AB_REPEAT_EN 0x0 // AB点复读
#define TCFG_DEC_DECRYPT_ENABLE 0x0 // 加密文件播
#define TCFG_DEC_DECRYPT_KEY 0x12345678 // 加密KEY
#define MUSIC_PLAYER_CYCLE_ALL_DEV_EN 0x1 // 循环播放模式是否循环所有设备
#define MUSIC_PLAYER_PLAY_FOLDER_PREV_FIRST_FILE_EN 0x0 // 切换文件夹播放时从第一首歌开始
#define TWFG_APP_POWERON_IGNORE_DEV 4000 // 设备忽略时间（单位：ms）
#define TCFG_FIX_CLOCK_FREQ 0x0 // 固定时钟频率
...
#define TCFG_LP_NFC_TAG_UID0 0x0 // TAG UID0
#define TCFG_LP_NFC_TAG_UID1 0x0 // TAG UID1
#define TCFG_LP_NFC_TAG_UID2 0x0 // TAG UID2
#define TCFG_LP_NFC_TAG_UID3 0x0 // TAG UID3
#define TCFG_LP_NFC_TAG_UID4 0x0 // TAG UID4
#define TCFG_LP_NFC_TAG_UID5 0x0 // TAG UID5
#define TCFG_LP_NFC_TAG_UID6 0x0 // TAG UID6
#endif // TCFG_LP_NFC_TAG_ENABLE

#define TCFG_MIX_RECORD_ENABLE 0x0 // 混合录音使能
// ------------功能配置.json------------
...
#define TCFG_LONG_PRESS_RESET_TIME 0x8 // 复位时间
#define TCFG_LONG_PRESS_RESET_LEVEL 0x0 // 复位电平
#define TCFG_LONG_PRESS_RESET_INSIDE_PULL_UP_DOWN 0x0 // 使用IO内置上下拉
...
// ------------电源配置.json------------
#define TCFG_CLOCK_OSC_HZ 0x16e3600 // 晶振频率
...
#define TCFG_LOWPOWER_LOWPOWER_SEL 0x0 // 低功耗模式
#define TCFG_AUTO_POWERON_ENABLE 0x1 // 上电自动开机
...
#define TCFG_LDOIN_ON_FILTER_TIME 0x64 // 入舱滤波时间(ms)
#define TCFG_LDOIN_OFF_FILTER_TIME 0xc8 // 出舱滤波时间(ms)
#define TCFG_LDOIN_KEEP_FILTER_TIME 0x1b8 // 维持电压滤波时间(ms)
...
#define TCFG_LCD_PIN_RESET IO_PORTB_03 // LCD RESET
#define TCFG_LCD_PIN_CS IO_PORTB_07 // LCD CS
#define TCFG_LCD_PIN_BL IO_PORTC_09 // LCD BLCKLIGHT
#define TCFG_LCD_PIN_DC IO_PORTB_08 // LCD DC
...
#define TCFG_BT_PAGE_TIMEOUT 0x8 // 单次回连时间(s)
#define TCFG_BT_POWERON_PAGE_TIME 0x1e // 开机回连超时(s)
#define TCFG_BT_TIMEOUT_PAGE_TIME 0x78 // 超距断开回连超时(s)
#define TCFG_DUAL_CONN_INQUIRY_SCAN_TIME 0x78 // 开机可被发现时间 (s)
#define TCFG_DUAL_CONN_PAGE_SCAN_TIME 0x0 // 等待第二台连接时间(s)
#define TCFG_AUTO_SHUT_DOWN_TIME 0x0 // 无连接关机时间(s)
#define TCFG_A2DP_DELAY_TIME_SBC 0x12c // A2DP延时SBC(msec)
...
#define TCFG_BT_VOL_SYNC_ENABLE 0x1 // 音量同步
#define TCFG_BT_DISPLAY_BAT_ENABLE 0x1 // 电量显示
#define TCFG_BT_DUAL_CONN_ENABLE 0x0 // 一拖二
#define TCFG_BT_INBAND_RING 0x1 // 手机铃声
#define TCFG_BT_PHONE_NUMBER_ENABLE 0x0 // 来电报号
#define TCFG_BT_MUSIC_INFO_ENABLE 0x0 // 歌曲信息显示
#define TCFG_A2DP_PREEMPTED_ENABLE 0x0 // 音频抢播
#define TCFG_BT_SUPPORT_AAC 0x1 // AAC
#define TCFG_BT_MSBC_EN 0x1 // MSBC
#define TCFG_BT_SBC_BITPOOL 0x35 // sbcBitPool
#define TCFG_AAC_BITRATE 0x4e200 // AAC码率
#define TCFG_BT_SUPPORT_LHDC 0x0 // LHDC_V3/V4
#define TCFG_BT_SUPPORT_LHDC_V5 0x0 // LHDC_V5
#define TCFG_BT_SUPPORT_LDAC 0x0 // LDAC
#define TCFG_BT_SUPPORT_HFP 0x1 // HFP
#define TCFG_BT_SUPPORT_AVCTP 0x1 // AVRCP
#define TCFG_BT_SUPPORT_A2DP 0x1 // A2DP
#define TCFG_BT_SUPPORT_HID 0x1 // HID
#define TCFG_BT_SUPPORT_SPP 0x1 // SPP
#define TCFG_BT_SUPPORT_PNP 0x1 // PNP
#define TCFG_BT_SUPPORT_PBAP 0x0 // PBAP
#define TCFG_BT_SUPPORT_IAP 0x0 // IAP
#define TCFG_BT_BACKGROUND_ENABLE 0x1 // 蓝牙后台
...
#define CONFIG_TWS_USE_COMMMON_ADDR 0x1 // MAC地址
...
#define TCFG_TWS_PAIR_TIMEOUT 0x6 // 开机配对超时(s)
#define TCFG_TWS_CONN_TIMEOUT 0x6 // 单次连接超时(s)
#define TCFG_TWS_PAIR_ALWAYS 0x0 // 单台连手机也能进行配对
#define CONFIG_TWS_POWEROFF_SAME_TIME 0x1 // 同步关机
#define CONFIG_TWS_AUTO_PAIR_WITHOUT_UNPAIR 0x1 // TWS连接超时自动配对新音箱
#define TCFG_TWS_PAIR_BY_BOTH_SIDES 0x0 // 两边同时按配对键进入配对
#define TCFG_TWS_AUTO_ROLE_SWITCH_ENABLE 0x0 // 自动主从切换
#define TCFG_TWS_POWER_BALANCE_ENABLE 0x0 // 主从电量平衡
#define TCFG_LOCAL_TWS_ENABLE 0x0 // TWS本地音乐转发
#define TCFG_LOCAL_TWS_SYNC_VOL 0x0 // TWS本地音乐音量同步
#define TCFG_BACKGROUND_WITHOUT_EDR_CONNECT 0x0 // 后台关闭经典蓝牙连接
#endif // TCFG_USER_TWS_ENABLE

#define TCFG_BT_SNIFF_ENABLE 0 // sniff
#if TCFG_BT_SNIFF_ENABLE
#define TCFG_SNIFF_CHECK_TIME 0x2 // 检测时间
#define CONFIG_LRC_WIN_SIZE 0x190 // LRC窗口初值
#define CONFIG_LRC_WIN_STEP 0x190 // LRC窗口步进
#define CONFIG_OSC_WIN_SIZE 0x190 // OSC窗口初值
#define CONFIG_OSC_WIN_STEP 0x190 // OSC窗口步进
#endif // TCFG_BT_SNIFF_ENABLE

#define TCFG_USER_BLE_ENABLE 0 // BLE
#if TCFG_USER_BLE_ENABLE
#define TCFG_BT_BLE_TX_POWER 0x5 // 最大发射功率
#define TCFG_BT_BLE_BREDR_SAME_ADDR 0x1 // 和2.1同地址
#endif // TCFG_USER_BLE_ENABLE

#define TCFG_THIRD_PARTY_PROTOCOLS_ENABLE 0 // AI配置
#if TCFG_THIRD_PARTY_PROTOCOLS_ENABLE
#define TCFG_THIRD_PARTY_PROTOCOLS_SEL TRANS_DATA_EN // AI协议选择
...
#define TCFG_TEST_BOX_ENABLE 0x0 // 测试盒串口升级
#define TCFG_UPDATE_UART_IO_EN 0x0 // 普通io串口升级
#define TCFG_UPDATE_UART_ROLE 0x0 // 串口升级主从机选择
#define TCFG_UART_UPDATE_TX_PIN 0 // TX_IO选择
#define TCFG_UART_UPDTAE_RX_PIN 0 // RX_IO选择
#define CONFIG_UPDATE_JUMP_TO_MASK 0x0 // 升级维持io使能
#define CONFIG_SD_LATCH_IO PB02_PB08 // SD卡升级需要维持的IO
#define CONFIG_UPDATE_MUTIL_CPU_UART 0x0 // 多芯片交互升级
...
#define TCFG_AUDIO_GLOBAL_SAMPLE_RATE 0xac44 // 全局采样率
#define TCFG_AEC_TOOL_ONLINE_ENABLE 0x0 // 手机APP在线调试
#define TCFG_AUDIO_CVP_SYNC 0x1 // 通话上行同步
#define TCFG_AUDIO_DMS_DUT_ENABLE 0x1 // 通话产测
...
#define TCFG_KWS_VOICE_RECOGNITION_ENABLE 0x0 // 关键词检测KWS
#define TCFG_KWS_MIC_CHA_SELECT AUDIO_ADC_MIC_0 // 麦克风选择
#define TCFG_SMART_VOICE_ENABLE 0x0 // 离线语音识别
#define TCFG_SMART_VOICE_USE_AEC 0x0 // 回音消除使能
#define TCFG_SMART_VOICE_MIC_CH_SEL AUDIO_ADC_MIC_0 // 麦克风选择
#define TCFG_AUDIO_KWS_LANGUAGE_SEL KWS_CH // 模式选择
#define TCFG_DEC_WAV_ENABLE 0 // WAV、WAV
#define TCFG_DEC_MP3_ENABLE 1 // MP3
#define TCFG_DEC_FLAC_ENABLE 0x1 // FLAC
#define TCFG_DEC_WMA_ENABLE 0x1 // WMA
#define TCFG_DEC_APE_ENABLE 0x1 // APE
#define TCFG_DEC_AAC_ENABLE 0 // AAC、AAC
#define TCFG_DEC_F2A_ENABLE 0 // F2A、F2A
#define TCFG_DEC_WTG_ENABLE 0 // WTG、WTG
#define TCFG_DEC_MTY_ENABLE 0 // MTY、MTY
#define TCFG_DEC_WTS_ENABLE 0 // WTS、WTS
#define TCFG_DEC_JLA_ENABLE 0x0 // JLA
#define TCFG_ENC_MSBC_ENABLE 0x1 // MSBC
#define TCFG_ENC_CVSD_ENABLE 0x1 // CVSD
#define TCFG_ENC_JLA_ENABLE 0x1 // JLA
#define TCFG_ENC_SBC_ENABLE 0x1 // SBC
#define TCFG_ENC_MP3_ENABLE 0x0 // MP3
#define TCFG_ENC_MP3_TYPE 0x0 // MP3格式选择
#define TCFG_ENC_ADPCM_ENABLE 0x0 // ADPCM
#define TCFG_ENC_ADPCM_TYPE 0x0 // ADPCM格式选择
#define TCFG_ENC_PCM_ENABLE 0x0 // PCM
