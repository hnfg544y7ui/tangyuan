...
#define TCFG_ONLINE_TX_PORT IO_PORTB_08 // 串口引脚TX
...
#define TCFG_SD0_PORT_CMD IO_PORTB_07 // SD_PORT_CMD
...
#define TCFG_APP_FM_EN 1 // FM模式
#define TCFG_APP_SPDIF_EN 1 // SPDIF模式
#define TCFG_APP_PC_EN 1 // PC模式
#define TCFG_APP_RECORD_EN 1 // 录音模式
#define TCFG_APP_RTC_EN 1 // RTC模式
#define TCFG_APP_IIS_EN 1 // IIS模式
...
#define TCFG_LP_NFC_TAG_ENABLE 1 // NFC配置
...
#define TCFG_CLOCK_SYS_SRC 0 // 系统时钟源选择
...
#define TCFG_BT_SUPPORT_PBAP 1 // PBAP
...
#define TCFG_H4_UART_RX_PIN IO_PORTB_08 // 串口接收
...
#define TCFG_BT_BLE_TX_POWER 6 // 最大发射功率
