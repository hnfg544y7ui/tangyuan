...
#include "ui/style_jl02.h"//点阵屏//
#include "ui/style_soundbar.h"//点阵屏//
...
#define ID_WINDOW_MAIN     (-1)
#define ID_WINDOW_BT       PAGE_0
#define ID_WINDOW_FM       PAGE_1
#define ID_WINDOW_CLOCK    (-1)
#define ID_WINDOW_MUSIC    PAGE_2
#define ID_WINDOW_LINEIN   PAGE_5
#define ID_WINDOW_POWER_ON     PAGE_3
#define ID_WINDOW_POWER_OFF    PAGE_4
#define ID_WINDOW_SYS      (-1)
#define ID_WINDOW_PC       (-1)
#define ID_WINDOW_IDLE      PAGE_4
#define ID_WINDOW_REC      (-1)
#define ID_WINDOW_SPDIF       PAGE_6
