...
enum {
    ...
    APP_MSG_LE_AUDIO_SW_CONNECT_DEIVCE,
    ...
    APP_MSG_WIRED_MIC_OFFLINE,
    APP_MSG_WIRED_MIC_ONLINE,

    APP_MSG_LOUDSPEAKER_OPEN,
    APP_MSG_LOUDSPEAKER_CLOSE,
    APP_MSG_LOUDSPEAKER_SOURCE_SWITCH,

    APP_MSG_DSP_OPEN,
    APP_MSG_DSP_CLOSE,

    APP_MSG_VM_FLUSH_FLASH,

    APP_MSG_BT_EMITTER_PLAY,
    APP_MSG_BT_EMITTER_PAUSE,

    APP_MSG_FINDMY_ENABLE,
    APP_MSG_FINDMY_DISABLE,

    APP_MSG_PLATE_REVERB_PARAM_SWITCH,
    APP_MSG_PLATE_REVERB_BYPASS,
    APP_MSG_LLNS_DNS_PARAM_SWITCH,
    APP_MSG_LLNS_DNS_BYPASS,
};
