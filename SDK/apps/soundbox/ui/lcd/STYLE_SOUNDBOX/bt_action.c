...
static int ui_bt_status_handler(const char *type, u32 arg)
{
    int ret;
...
static const struct uimsg_handl ui_msg_handler[] = {
    { "bt_status",        ui_bt_status_handler     }, /* 设置音量 */
...
static int bt_status_check(int p)
{
    u8 status = bt_get_connect_status();
    u8 eq_mode = 0;
