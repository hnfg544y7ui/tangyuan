...
#pragma bss_seg(".system_action.data.bss")
#pragma data_seg(".system_action.data")
#pragma const_seg(".system_action.text.const")
#pragma code_seg(".system_action.text")
#endif
#include "ui/ui.h"
...
#include "lcd/ui_sys_param_api.h"
