...
#pragma bss_seg(".clock_action.data.bss")
#pragma data_seg(".clock_action.data")
#pragma const_seg(".clock_action.text.const")
#pragma code_seg(".clock_action.text")
#endif
#include "ui/ui.h"
 ...
 ************************************************************/
//是时钟初始化消息入口
static int __time_set_switch_init(int id)
{
