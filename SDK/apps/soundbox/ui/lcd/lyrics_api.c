...
#pragma bss_seg(".lyrics_api.data.bss")
#pragma data_seg(".lyrics_api.data")
#pragma const_seg(".lyrics_api.text.const")
#pragma code_seg(".lyrics_api.text")
#endif
