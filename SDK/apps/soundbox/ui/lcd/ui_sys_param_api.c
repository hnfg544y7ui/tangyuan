...
#pragma bss_seg(".ui_sys_param_api.data.bss")
#pragma data_seg(".ui_sys_param_api.data")
#pragma const_seg(".ui_sys_param_api.text.const")
#pragma code_seg(".ui_sys_param_api.text")
#endif
#include "ui/ui.h"
...
static void app_key_event(struct sys_event *e)
{
