...
#include "board_ac703n_demo_global_build_cfg.h"
...
SDK_VERSION = ac703n_V106; //jenkins脚本生成
...
#ifndef CONFIG_FATFSI_ADDR
#define CONFIG_FATFSI_ADDR	AUTO
#endif

#ifndef CONFIG_FATFSI_LEN
#define CONFIG_FATFSI_LEN	0x10000
#endif

#ifndef CONFIG_FATFSI_OPT
#define CONFIG_FATFSI_OPT	0
#endif
...
FATFSI_ADR = CONFIG_FATFSI_ADDR;
FATFSI_LEN = CONFIG_FATFSI_LEN;
FATFSI_OPT = CONFIG_FATFSI_OPT;
