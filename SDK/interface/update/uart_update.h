...
u32 uart_update_read(u8 *data, u32 len, u32 timeout_ms);
u32 uart_update_read_no_timeout(u8 *data, u32 len);
u32 uart_update_write(u8 *data, u32 len, u32 timeout_ms);
