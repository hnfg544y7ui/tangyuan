...
#else /* #if (CPU_CORE_NUM > 1) */
#define OS_CORE_AFFINITY_ENABLE     1 //Fixed, No Modify If OS In Maskrom
...
#define CORE_IDLE_TICK_TIMER_PERIOD 		1000 //10 ~ 16000 ms
...
__attribute__((always_inline))
static void q32DSP_testclr(u8 volatile *ptr)
{
    asm volatile(
        " b[%0] = %1    \n\t "
        :
