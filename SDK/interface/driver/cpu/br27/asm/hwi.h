...
#define IRQ_TIME3_IDX      		7
#define IRQ_TIME4_IDX      		8
#define IRQ_TIME5_IDX      		9

#define IRQ_UART0_IDX      		12
#define IRQ_UART1_IDX      		13
#define IRQ_UART2_IDX      		14

#define IRQ_SPI0_IDX       		16
#define IRQ_SPI1_IDX       		17
#define IRQ_SPI2_IDX       		18
#define IRQ_SD1_IDX        		19
#define IRQ_SD0_IDX        		20

#define IRQ_IIC_IDX        		24
#define IRQ_LEDC_IDX        	25
#define IRQ_LCDC_IDX        	26

#define IRQ_FMRX_IDX		   	31
#define IRQ_P2M_IDX        		32
...
#define IRQ_GPADC_IDX		   	39
// #define IRQ_CTM_IDX             40
#define IRQ_PWM_LED_IDX		   	41
#define IRQ_OSA_IDX			   	42
#define IRQ_LRCT_IDX		   	43
#define IRQ_GPC_IDX			   	44
#define IRQ_FMTX_IDX		   	45
#define IRQ_TDM_IDX			   	46
#define IRQ_RDEC0_IDX		   	47
#define IRQ_SBC_IDX			   	48
#define IRQ_AES_IDX        		49
#define IRQ_RDEC1_IDX		   	50
#define IRQ_RDEC2_IDX		   	51
#define IRQ_MCPWM_CHX_IDX       52
#define IRQ_MCPWM_TMR_IDX       53
#define IRQ_SPDIF_S_IDX       	54
#define IRQ_USB_CTRL_IDX        55
#define IRQ_USB_SOF_IDX         56
#define IRQ_USB_TRIM_IDX        57
#define IRQ_SPDIF_M_IDX       	58

#define IRQ_AUDIO_IDX      		68
#define IRQ_ALINK0_IDX     		69
#define IRQ_PDM_LINK_IDX   		70
#define IRQ_AD2DA_IDX   		71

#define IRQ_CMAC_MTIMER_IDX   	73
#define IRQ_CMAC_EVT_IDX   		74
#define IRQ_CMAC_SOFT_IDX   	75
#define IRQ_BT_CLKN_IDX    		76
#define IRQ_BT_DBG_IDX     		77
#define IRQ_BLE_RX_IDX     		78
#define IRQ_BLE_EVENT_IDX  		79
#define IRQ_BT_TIMEBASE_IDX  	80
#define IRQ_WL_LOFC_IDX    		81
#define IRQ_BREDR_IDX      		82

#define IRQ_EQ1_IDX         	86
#define IRQ_IMD_IDX         	87
#define IRQ_SYNC_IDX      		88
#define IRQ_SRC_SYNC_IDX        89
#define IRQ_SRC_HW0_IDX       	90
#define IRQ_EQ_IDX         		91
#define IRQ_DCP_IDX	       		93
#define IRQ_SRC_HW1_IDX	       	94
#define IRQ_ALINK1_IDX	    	95
