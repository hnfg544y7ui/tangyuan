...
#define CHARGE_mA_400			15

/*涓流充电电流选择 1.5-40mA*/
#define CHARGE_TC_mA_1P5           (BIT(4)|CHARGE_mA_15)
#define CHARGE_TC_mA_2             (BIT(4)|CHARGE_mA_20)
#define CHARGE_TC_mA_2P5           (BIT(4)|CHARGE_mA_25)
#define CHARGE_TC_mA_3             (BIT(4)|CHARGE_mA_30)
#define CHARGE_TC_mA_3P5           (BIT(4)|CHARGE_mA_35)
#define CHARGE_TC_mA_4             (BIT(4)|CHARGE_mA_40)
#define CHARGE_TC_mA_5             (BIT(4)|CHARGE_mA_50)
#define CHARGE_TC_mA_6             (BIT(4)|CHARGE_mA_60)
#define CHARGE_TC_mA_8             (BIT(4)|CHARGE_mA_80)
#define CHARGE_TC_mA_10            (BIT(4)|CHARGE_mA_100)
#define CHARGE_TC_mA_12            (BIT(4)|CHARGE_mA_120)
#define CHARGE_TC_mA_14            (BIT(4)|CHARGE_mA_140)
#define CHARGE_TC_mA_16            (BIT(4)|CHARGE_mA_160)
#define CHARGE_TC_mA_20            (BIT(4)|CHARGE_mA_200)
#define CHARGE_TC_mA_30            (BIT(4)|CHARGE_mA_300)
#define CHARGE_TC_mA_40            (BIT(4)|CHARGE_mA_400)
