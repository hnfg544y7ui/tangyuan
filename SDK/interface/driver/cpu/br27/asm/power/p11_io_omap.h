...
#define P11_FO_NFC_MO        ((9 << 2)|BIT(1)|BIT(0))
...
typedef struct {
    ...
    //============= NO USE ===========//
    __RW __u8 P11_PB4_OUT_NO_USE;
    __RW __u8 P11_PB5_OUT_NO_USE;
    __RW __u8 P11_PB6_OUT_NO_USE;
    __RW __u8 P11_PB7_OUT_NO_USE;
    __RW __u8 P11_PB8_OUT_NO_USE;
    __RW __u8 P11_PB9_OUT_NO_USE;
    __RW __u8 P11_PB10_OUT_NO_USE;
    __RW __u8 P11_PB11_OUT_NO_USE;
    //===============================//
    __RW __u8 P11_PB12_OUT;
    __RW __u8 P11_PB13_OUT;
    __RW __u8 P11_PB14_OUT;
    __RW __u8 P11_PB15_OUT;
} P11_OMAP_TypeDef;
