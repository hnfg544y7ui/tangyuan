...
#define R3_PR_IO_P    (volatile u32 *)(0xd000 + 0xb0*4)
#else
#define RTC_ACCESS(x) (*(volatile u32 *)(0xf20000 + 0xd000 + x*4))
#define R3_PR_IO_P    (volatile u32 *)(0xf20000 + 0xd000 + 0xb0*4)
#endif
...
#define P3_OSL_CON                        R3_OSL_CON       //RTC power individual
...
#define P3_TMR0_CON0                        P33_ACCESS(0x20)
#define P3_TMR0_CON1                        P33_ACCESS(0x21)
#define P3_TMR0_PRD0                        P33_ACCESS(0x22)
#define P3_TMR0_PRD1                        P33_ACCESS(0x23)
#define P3_TMR0_PRD2                        P33_ACCESS(0x24)
#define P3_TMR0_PRD3                        P33_ACCESS(0x25)
...
#define P3_WVD_CON0                       P33_ACCESS(0x78)
#define P3_PVD_CON0                       P33_ACCESS(0x79)
#define P3_EVD_CON0                       P33_ACCESS(0x7a)
#define P3_NFC_CTL_CON0                   P33_ACCESS(0x7b)
#define P3_NFC_CTL_CON1                   P33_ACCESS(0x7c)
#define P3_NFC_CTL_CON2                   P33_ACCESS(0x7d)
#define P3_NFC_CTL_CON3                   P33_ACCESS(0x7e)

//............. 0x0080 - 0x008f............ for
#define P3_AWKUP_FLT0                     P33_ACCESS(0x80)
#define P3_AWKUP_FLT1                     P33_ACCESS(0x81)
#define P3_AWKUP_FLT2                     P33_ACCESS(0x82)
#define P3_AWKUP_FLT3                     P33_ACCESS(0x83)

#define P3_APORT_SEL0                     P33_ACCESS(0x88)
#define P3_APORT_SEL1                     P33_ACCESS(0x89)
#define P3_APORT_SEL2                     P33_ACCESS(0x8a)
#define P3_APORT_SEL3                     P33_ACCESS(0x8b)

//............. 0x0090 - 0x009f............ for
#define P3_PSW_CON0                       P33_ACCESS(0x90)
#define P3_PSW_CON1                       P33_ACCESS(0x91)
#define P3_PMU_ADC0                       P33_ACCESS(0x92)
#define P3_PMU_ADC1                       P33_ACCESS(0x93)
#define P3_VBG_CON0                       P33_ACCESS(0x94)
#define P3_IOV_CON0                       P33_ACCESS(0x95)
#define P3_IOV_CON1                       P33_ACCESS(0x96)
#define P3_DCV_CON0                       P33_ACCESS(0x97)
#define P3_DCD_CON0                       P33_ACCESS(0x98)
#define P3_DCD_CON1                       P33_ACCESS(0x99)
#define P3_DCD_CON2                       P33_ACCESS(0x9a)
#define P3_DCD_CON3                       P33_ACCESS(0x9b)
#define P3_DCD_CON4                       P33_ACCESS(0x9c)
#define P3_DVD_CON0                       P33_ACCESS(0x9d)
#define P3_RVD_CON0                       P33_ACCESS(0x9e)
#define P3_RVD_CON1                       P33_ACCESS(0x9f)
...
#define P3_ANA_CON                        P33_ACCESS(0xa9)
#define P3_PMU_DBG_CON                    P33_ACCESS(0xaa)
#define P3_MFIX_OPT                       P33_ACCESS(0xab)
...
#define P3_LS_IO_SHA                      P33_ACCESS(0xd2)
#define P3_LS_FLASHB                      P33_ACCESS(0xd3)
#define P3_LS_RF                          P33_ACCESS(0xd4)
#define P3_LS_ADC                         P33_ACCESS(0xd5)
#define P3_LS_AUDIO                       P33_ACCESS(0xd6)
#define P3_LS_PLL                         P33_ACCESS(0xd7)
#define P3_LS_CTMU                        P33_ACCESS(0xd8)
#define P3_LS_NFC                         P33_ACCESS(0xd9)
#define P3_LS_LCD                         P33_ACCESS(0xda)
#define P3_LS_SPDIF                       P33_ACCESS(0xdb)
