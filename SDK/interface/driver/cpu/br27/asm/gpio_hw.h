...
#define IO_PORT_MAX					(IO_PORT_PR_01 + 1)
...
#define IO_SPDIF_RX_DET             (IO_PORT_MAX + P33_IO_OFFSET + 5)
...
struct usb_reg {
    volatile unsigned int out: 2; //0
        ...
        volatile unsigned int pd0: 2; //8
        volatile unsigned int die: 2; //10
...
#define GPIO_USB_DIEH_REG_NUM 0
...
#define GPIO_PR_PU_REG_NUM 2
#define GPIO_PR_PD_REG_NUM 2
#define GPIO_PR_HD_REG_NUM 2
...
#define PORT_INPUT_PULLUP_10K  PORT_INPUT_PULLUP_LEVEL1
#define PORT_INPUT_PULLUP_100K PORT_INPUT_PULLUP_LEVEL2
#define PORT_INPUT_PULLUP_1M   PORT_INPUT_PULLUP_LEVEL3
#define PORT_INPUT_PULLUP_200K PORT_INPUT_PULLUP_100K

#define PORT_INPUT_PULLDOWN_10K  PORT_INPUT_PULLDOWN_LEVEL1
#define PORT_INPUT_PULLDOWN_100K PORT_INPUT_PULLDOWN_LEVEL2
#define PORT_INPUT_PULLDOWN_1M   PORT_INPUT_PULLDOWN_LEVEL3
#define PORT_INPUT_PULLDOWN_200K PORT_INPUT_PULLDOWN_100K
// ----------------------------------------
...
enum PFI_TABLE {
    ...
    PFI_SD1_CMD = ((u32)(&(JL_IMAP->FI_SD1_CMD))),
    PFI_SD1_DA0 = ((u32)(&(JL_IMAP->FI_SD1_DA0))),
    PFI_SD1_DA1 = ((u32)(&(JL_IMAP->FI_SD1_DA1))),
    PFI_SD1_DA2 = ((u32)(&(JL_IMAP->FI_SD1_DA2))),
    PFI_SD1_DA3 = ((u32)(&(JL_IMAP->FI_SD1_DA3))),
    PFI_IIC_SCL = ((u32)(&(JL_IMAP->FI_IIC_SCL))),
    PFI_IIC_SDA = ((u32)(&(JL_IMAP->FI_IIC_SDA))),
    PFI_UART0_RX = ((u32)(&(JL_IMAP->FI_UART0_RX))),
    PFI_UART0_CTS = ((u32)(&(JL_IMAP->FI_UART0_CTS))),
    ...
    PFI_QDEC0_DAT0 = ((u32)(&(JL_IMAP->FI_QDEC0_DAT0))),
    PFI_QDEC0_DAT1 = ((u32)(&(JL_IMAP->FI_QDEC0_DAT1))),
    PFI_QDEC1_DAT0 = ((u32)(&(JL_IMAP->FI_QDEC1_DAT0))),
    PFI_QDEC1_DAT1 = ((u32)(&(JL_IMAP->FI_QDEC1_DAT1))),
    PFI_QDEC2_DAT0 = ((u32)(&(JL_IMAP->FI_QDEC2_DAT0))),
    PFI_QDEC2_DAT1 = ((u32)(&(JL_IMAP->FI_QDEC2_DAT1))),
    ...
    PFI_ALNK1_MCLK = ((u32)(&(JL_IMAP->FI_ALNK1_MCLK))),
    PFI_ALNK1_LRCK = ((u32)(&(JL_IMAP->FI_ALNK1_LRCK))),
    PFI_ALNK1_SCLK = ((u32)(&(JL_IMAP->FI_ALNK1_SCLK))),
    PFI_ALNK1_DAT0 = ((u32)(&(JL_IMAP->FI_ALNK1_DAT0))),
    PFI_ALNK1_DAT1 = ((u32)(&(JL_IMAP->FI_ALNK1_DAT1))),
    PFI_ALNK1_DAT2 = ((u32)(&(JL_IMAP->FI_ALNK1_DAT2))),
    PFI_ALNK1_DAT3 = ((u32)(&(JL_IMAP->FI_ALNK1_DAT3))),
    ...
    PFI_MCPWM2_CK = ((u32)(&(JL_IMAP->FI_MCPWM2_CK))),
    PFI_MCPWM3_CK = ((u32)(&(JL_IMAP->FI_MCPWM3_CK))),
    PFI_MCPWM4_CK = ((u32)(&(JL_IMAP->FI_MCPWM4_CK))),
    PFI_MCPWM5_CK = ((u32)(&(JL_IMAP->FI_MCPWM5_CK))),
    PFI_MCPWM0_FP = ((u32)(&(JL_IMAP->FI_MCPWM0_FP))),
    PFI_MCPWM1_FP = ((u32)(&(JL_IMAP->FI_MCPWM1_FP))),
    PFI_MCPWM2_FP = ((u32)(&(JL_IMAP->FI_MCPWM2_FP))),
    PFI_MCPWM3_FP = ((u32)(&(JL_IMAP->FI_MCPWM3_FP))),
    PFI_MCPWM4_FP = ((u32)(&(JL_IMAP->FI_MCPWM4_FP))),
    PFI_MCPWM5_FP = ((u32)(&(JL_IMAP->FI_MCPWM5_FP))),
...
#define  INPUT_GP_ICH_MAX  10
#define  OUTPUT_GP_OCH_MAX 10
...
enum OUTPUT_CH_SIGNAL {
    ...
    OUTPUT_CH_SIGNAL_PI_GP_ICH8,
    OUTPUT_CH_SIGNAL_PI_GP_ICH9,
    OUTPUT_CH_SIGNAL_WL_AMPE,
    OUTPUT_CH_SIGNAL_WL_LNAE,
    OUTPUT_CH_SIGNAL_LEDC_OUT0,
    OUTPUT_CH_SIGNAL_LEDC_OUT1,
    OUTPUT_CH_SIGNAL_LEDC_OUT2,
...
enum INPUT_CH_SIGNAL {
    ...
    INPUT_CH_SIGNAL_RESERVE6,
};
enum gpio_function {
    PORT_FUNC_NULL,    //null
    PORT_FUNC_UART0_TX, //out
    PORT_FUNC_UART0_RX,//in
    PORT_FUNC_UART0_RTS,//out
    PORT_FUNC_UART0_CTS,//in
...
//log:
#define GPIO_LOG_FORMAT "0x%04x  0x%04x  0x%04x  0x%04x  0x%04x,0x%04x  0x%04x,0x%04x  0x%04x,0x%04x  %s"
#define GPIO_NO_SUPPORT_FUN "------"
#define GPIO_LOG_PORT(x,y) JL_PORT##x->OUT&y,JL_PORT##x->DIR&y,JL_PORT##x->DIE&y,JL_PORT##x->DIEH&y,JL_PORT##x->PU0&y,JL_PORT##x->PU1&y,JL_PORT##x->PD0&y,JL_PORT##x->PD1&y,JL_PORT##x->HD0&y,JL_PORT##x->HD1&y,GPIO_NO_SUPPORT_FUN
#ifdef GPIOP
...
#endif
#ifdef GPIOUSB
#define GPIO_LOG_FORMAT_U "0x%04x  0x%04x  0x%04x  %s  0x%04x,0x%04x  0x%04x,%s  %s,%s  %s"
#define GPIO_LOG_PORTU _portx(PU,out),_portx(PU,dir),_portx(PU,die),GPIO_NO_SUPPORT_FUN,_portx(PU,pu0),_portx(PU,pu1),_portx(PU,pd0),GPIO_NO_SUPPORT_FUN,GPIO_NO_SUPPORT_FUN,GPIO_NO_SUPPORT_FUN,GPIO_NO_SUPPORT_FUN
#endif
