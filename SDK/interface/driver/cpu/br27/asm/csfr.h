...
typedef struct {
    __RW __u32 CON[15]; // 0-7 used in br27
    __RO __u32 REV0;
    __RW __u32 CID[15]; // 0-7 used in br27
    __RO __u32 REV1;
    __RW __u32 BEG[15]; // 0-7 used in br27
    __RO __u32 REV2;
    __RW __u32 END[15]; // 0-7 used in br27
    __RW __u32 WREN;
} JL_MPU_TypeDef;
