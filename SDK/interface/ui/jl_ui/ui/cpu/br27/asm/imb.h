...
struct imb_task {
    ...
    struct imb_quote_cb_priv quote_cb_priv;
};
...
struct imb_task *imb_task_list_init(struct imb_task_head *root, struct imb_task_info *info);
...
void imb_start_no_block(struct imb_task_head *root, struct rect *limit, struct rect disp, u16 colums, u16 lines, struct imb_cb_interface *itf);
