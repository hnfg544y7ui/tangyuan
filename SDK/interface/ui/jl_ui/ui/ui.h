...
//注意这里的数值不可更改,要与ui底层的KEY_xx 一致
#define  UI_KEY_POWER_START     0
#define  UI_KEY_POWER           1
#define  UI_KEY_PREV            2
#define  UI_KEY_NEXT            3
#define  UI_KEY_OK 			    4
#define  UI_KEY_CANCLE 			5
#define  UI_KEY_MENU 			6
#define  UI_KEY_MODE 			7
#define  UI_KEY_PHOTO           8
#define  UI_KEY_ENC             9
#define  UI_KEY_VOLUME_DEC      10
#define  UI_KEY_VOLUME_INC      11
#define  UI_KEY_PHONE           12

#define  UI_KEY_LEFT 			37
#define  UI_KEY_UP 				38
#define  UI_KEY_RIGHT 			39
#define  UI_KEY_DOWN 			40
