...
/*设置iis buf大小，dma_len / 2 的值为中断起一次的长度len的值*/
...
u32 audio_iis_fix_dma_len(u32 module_idx, u32 tx_dma_buf_time_ms, u16 rx_irq_points, u8 bit_width, u8 ch_num, u32 max_sr);
