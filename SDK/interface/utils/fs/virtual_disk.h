...
extern const struct device_operations vir_udisk0_ops;
...
#if 0
extern void vir_disk_rand_file_size();
extern void virtual_disk_reduce_file_size(tu8 file_num);
extern void virtual_disk_remove_files(tu8 file_type);
extern void virtual_disk_reduce_file_size(tu8 file_num);
extern u8 vir_disk_init(void *buf_512, void (*fun_read_file)(u32, u32, u8 *, u32));
#endif

extern const int ENABLE_VIR_UDISK_AURACAST;

extern int virtual_file_read(void *buf, u32 addr, u32 len);
extern int virtual_file_write(void *buf, u32 len);
