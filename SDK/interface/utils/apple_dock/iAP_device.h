...
extern u16 iAP_dev_crack(u8 *TxBuf, u8 *RxBuf, u8 len);
extern u16 iAP_dev_X509(u8 *RxBuf, u16 max_len);
extern void iap_crack_init(u16(*auth_cb)(u8 cmd, u8 *buf, u16 len));
extern u8 apple_mfi_chip_online_check_api(void);
extern int  apple_dock_init(void);
